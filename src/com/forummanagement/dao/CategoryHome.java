 ...
 * @see com.forummanagement.dao.Category
...
public class CategoryHome {
	...
	public Category findById(java.lang.Integer id) {
		...
		try {
			Category instance = (Category) sessionFactory.getCurrentSession().get("com.forummanagement.dao.Category", id);
			if (instance == null) {
	...
	public List findByExample(Category instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.forummanagement.dao.Category").add(Example.create(instance)).list();
