 ...
 * @see com.forummanagement.dao.Post
...
public class PostHome {
	...
	public Post merge(Post detachedInstance) {
		...
		try {
			Post result = (Post) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Post findById(java.lang.Integer id) {
		...
		try {
			Post instance = (Post) sessionFactory.getCurrentSession().get("com.forummanagement.dao.Post", id);
			if (instance == null) {
	...
	public List findByExample(Post instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.forummanagement.dao.Post").add(Example.create(instance)).list();
