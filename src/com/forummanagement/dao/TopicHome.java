 ...
 * @see com.forummanagement.dao.Topic
...
public class TopicHome {
	...
	public Topic merge(Topic detachedInstance) {
		...
		try {
			Topic result = (Topic) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Topic findById(java.lang.Integer id) {
		...
		try {
			Topic instance = (Topic) sessionFactory.getCurrentSession().get("com.forummanagement.dao.Topic", id);
			if (instance == null) {
	...
	public List findByExample(Topic instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.forummanagement.dao.Topic").add(Example.create(instance)).list();
